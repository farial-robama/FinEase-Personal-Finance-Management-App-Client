  ...
  <div className="hero-content flex-col">
    ...
    <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl my-9">
      <div className="card-body">
        ...
        <div><Link to="/auth/forget-password" state={ {email} } className="link link-hover font-bold text-red-600">Forgot password?</Link></div>
        
          <button className="btn btn-active btn-info text-white">Login</button>
  ...
  Login with Google
            ...
            <div>
                <p>
                    ...
                    <Link to="/auth/register" className='text-[#954ef9] text-sm font-bold link link-hover'>
                    Register
                    </Link>
                </p>
            </div>
